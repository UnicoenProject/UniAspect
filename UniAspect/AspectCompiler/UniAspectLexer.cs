// $ANTLR 3.3 Nov 30, 2010 12:50:56 UniAspect.g 2012-01-15 14:12:04
...
public partial class UniAspectLexer : Antlr.Runtime.Lexer
{
	...
	public UniAspectLexer()
	{
		OnCreated();
	}

	public UniAspectLexer(ICharStream input )
	...
	private void mT__33()
	{
		...
		try
		{
			...
			// UniAspect.g:7:7: ( 'aspect' )
			DebugEnterAlt(1);
			// UniAspect.g:7:9: 'aspect'
			{
			DebugLocation(7, 9);
			Match("aspect"); 
	...
	private void mT__36()
	{
		...
		try
		{
			int _type = T__36;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:10:7: ( '}end' )
			DebugEnterAlt(1);
			// UniAspect.g:10:9: '}end'
			{
			DebugLocation(10, 9);
			Match("}end"); 
	...
	private void mT__38()
	{
		...
		try
		{
			int _type = T__38;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:12:7: ( 'Java' )
			DebugEnterAlt(1);
			// UniAspect.g:12:9: 'Java'
			{
			DebugLocation(12, 9);
			Match("Java"); 
	...
	private void mT__39()
	{
		...
		try
		{
			int _type = T__39;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:13:7: ( 'JavaScript' )
			DebugEnterAlt(1);
			// UniAspect.g:13:9: 'JavaScript'
			{
			DebugLocation(13, 9);
			Match("JavaScript"); 
	...
	private void mT__40()
	{
		...
		try
		{
			int _type = T__40;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:14:7: ( 'CSharp' )
			DebugEnterAlt(1);
			// UniAspect.g:14:9: 'CSharp'
			{
			DebugLocation(14, 9);
			Match("CSharp"); 
	...
	private void mT__41()
	{
		...
		try
		{
			int _type = T__41;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:15:7: ( 'Ruby' )
			DebugEnterAlt(1);
			// UniAspect.g:15:9: 'Ruby'
			{
			DebugLocation(15, 9);
			Match("Ruby"); 
	...
	private void mT__42()
	{
		...
		try
		{
			int _type = T__42;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:16:7: ( 'Python' )
			DebugEnterAlt(1);
			// UniAspect.g:16:9: 'Python'
			{
			DebugLocation(16, 9);
			Match("Python"); 
	...
	private void mT__45()
	{
		...
		try
		{
			int _type = T__45;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:19:7: ( 'pointcut' )
			DebugEnterAlt(1);
			// UniAspect.g:19:9: 'pointcut'
			{
			DebugLocation(19, 9);
			Match("pointcut"); 
	...
	private void mSTRING()
	{
		...
		try
		{
			int _type = STRING;
			int _channel = DefaultTokenChannel;
			// UniAspect.g:174:5: ( '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"' )
			DebugEnterAlt(1);
			// UniAspect.g:174:8: '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"'
			{
			DebugLocation(174, 8);
			Match('\"'); 
			DebugLocation(174, 12);
			// UniAspect.g:174:12: ( EscapeSequence | ~ ( '\\\\' | '\"' ) )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// UniAspect.g:174:14: EscapeSequence
					{
	...
	private void mINTLITERAL()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// UniAspect.g:178:2: ( ( '1' .. '9' ) ( '0' .. '9' )* )
			DebugEnterAlt(1);
			// UniAspect.g:178:4: ( '1' .. '9' ) ( '0' .. '9' )*
			{
			DebugLocation(178, 4);
			// UniAspect.g:178:4: ( '1' .. '9' )
			DebugEnterAlt(1);
			// UniAspect.g:178:5: '1' .. '9'
			{
			DebugLocation(178, 5);
			MatchRange('1','9'); 
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// UniAspect.g:183:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) )
			DebugEnterAlt(1);
			// UniAspect.g:183:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
			{
			DebugLocation(183, 9);
			Match('\\'); 
	...
	{
		// UniAspect.g:1:8: ( T__33 | T__34 | T__35 | T__36 | T__37 | T__38 | T__39 | T__40 | T__41 | T__42 | T__43 | T__44 | T__45 | T__46 | T__47 | T__48 | T__49 | T__50 | ADVICE_TYPE_ELEMENT | IDENTIFIER | STRING | INTLITERAL | OTHERS | WS )
		int alt7=24;
		...
		case 19:
			DebugEnterAlt(19);
			// UniAspect.g:1:118: ADVICE_TYPE_ELEMENT
			{
			DebugLocation(1, 118);
	...
	private class DFA7 : DFA
	{
		...
		public override string Description { get { return "1:1: Tokens : ( T__33 | T__34 | T__35 | T__36 | T__37 | T__38 | T__39 | T__40 | T__41 | T__42 | T__43 | T__44 | T__45 | T__46 | T__47 | T__48 | T__49 | T__50 | ADVICE_TYPE_ELEMENT | IDENTIFIER | STRING | INTLITERAL | OTHERS | WS );"; } }
