// $ANTLR 3.3 Nov 30, 2010 12:50:56 UniAspect.g 2012-01-15 14:12:03
...
public partial class UniAspectParser : Antlr.Runtime.Parser
{
	...
	#endif
	public UniAspectParser( ITokenStream input )
		: this( input, new RecognizerSharedState() )
	{
	}
	public UniAspectParser(ITokenStream input, RecognizerSharedState state)
		: base(input, state)
	{
	...
	public override string[] TokenNames { get { return UniAspectParser.tokenNames; } }
	public override string GrammarFileName { get { return "UniAspect.g"; } }
	...
	// $ANTLR start "aspect"
	// UniAspect.g:33:1: aspect : 'aspect' IDENTIFIER aspectBody -> ^( ASPECT IDENTIFIER aspectBody ) ;
	[GrammarRule("aspect")]
	public UniAspectParser.aspect_return aspect()
	{
		Enter_aspect();
		EnterRule("aspect", 1);
		TraceIn("aspect", 1);
		UniAspectParser.aspect_return retval = new UniAspectParser.aspect_return();
		...
		UniAspectParser.aspectBody_return aspectBody3 = default(UniAspectParser.aspectBody_return);
		...
		try
		{
			// UniAspect.g:34:2: ( 'aspect' IDENTIFIER aspectBody -> ^( ASPECT IDENTIFIER aspectBody ) )
			DebugEnterAlt(1);
			// UniAspect.g:34:4: 'aspect' IDENTIFIER aspectBody
			{
			DebugLocation(34, 4);
			...
			{
			// AST REWRITE
			// elements: aspectBody, IDENTIFIER
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
			...
			{
				DebugLocation(35, 6);
				// UniAspect.g:35:6: ^( ASPECT IDENTIFIER aspectBody )
				{
	...
	// UniAspect.g:38:1: aspectBody : '{' elements '}' -> ^( ASPECT_BODY elements ) ;
	[GrammarRule("aspectBody")]
	private UniAspectParser.aspectBody_return aspectBody()
	{
		Enter_aspectBody();
		EnterRule("aspectBody", 2);
		TraceIn("aspectBody", 2);
		UniAspectParser.aspectBody_return retval = new UniAspectParser.aspectBody_return();
		retval.Start = (IToken)input.LT(1);
		...
		UniAspectParser.elements_return elements5 = default(UniAspectParser.elements_return);
		...
		try
		{
			// UniAspect.g:39:2: ( '{' elements '}' -> ^( ASPECT_BODY elements ) )
			DebugEnterAlt(1);
			// UniAspect.g:39:4: '{' elements '}'
			{
			DebugLocation(39, 4);
			...
			{
				DebugLocation(40, 6);
				// UniAspect.g:40:6: ^( ASPECT_BODY elements )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(40, 8);
	...
	// UniAspect.g:43:1: elements : ( element )* -> ^( ELEMENTS ( element )* ) ;
	[GrammarRule("elements")]
	private UniAspectParser.elements_return elements()
	{
		Enter_elements();
		EnterRule("elements", 3);
		TraceIn("elements", 3);
		UniAspectParser.elements_return retval = new UniAspectParser.elements_return();
		retval.Start = (IToken)input.LT(1);

		object root_0 = null;

		UniAspectParser.element_return element7 = default(UniAspectParser.element_return);
		...
		try
		{
			// UniAspect.g:44:2: ( ( element )* -> ^( ELEMENTS ( element )* ) )
			DebugEnterAlt(1);
			// UniAspect.g:44:4: ( element )*
			{
			DebugLocation(44, 4);
			// UniAspect.g:44:4: ( element )*
			...
			{
				DebugLocation(45, 6);
				// UniAspect.g:45:6: ^( ELEMENTS ( element )* )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(45, 8);
	...
	// $ANTLR start "element"
	// UniAspect.g:48:1: element : ( intertypeDeclaration -> ^( ELEMENT intertypeDeclaration ) | pointcutDeclaration -> ^( ELEMENT pointcutDeclaration ) | adviceDeclaration -> ^( ELEMENT adviceDeclaration ) );
	[GrammarRule("element")]
	private UniAspectParser.element_return element()
	{
		Enter_element();
		EnterRule("element", 4);
		TraceIn("element", 4);
		UniAspectParser.element_return retval = new UniAspectParser.element_return();
		retval.Start = (IToken)input.LT(1);

		object root_0 = null;

		UniAspectParser.intertypeDeclaration_return intertypeDeclaration8 = default(UniAspectParser.intertypeDeclaration_return);
		UniAspectParser.pointcutDeclaration_return pointcutDeclaration9 = default(UniAspectParser.pointcutDeclaration_return);
		UniAspectParser.adviceDeclaration_return adviceDeclaration10 = default(UniAspectParser.adviceDeclaration_return);
		...
		try
		{
			// UniAspect.g:49:2: ( intertypeDeclaration -> ^( ELEMENT intertypeDeclaration ) | pointcutDeclaration -> ^( ELEMENT pointcutDeclaration ) | adviceDeclaration -> ^( ELEMENT adviceDeclaration ) )
			int alt2=3;
			...
			case 1:
				DebugEnterAlt(1);
				// UniAspect.g:49:4: intertypeDeclaration
				{
				DebugLocation(49, 4);
				...
				{
					DebugLocation(50, 6);
					// UniAspect.g:50:6: ^( ELEMENT intertypeDeclaration )
					{
					object root_1 = (object)adaptor.Nil();
					DebugLocation(50, 8);
			...
			case 2:
				DebugEnterAlt(2);
				// UniAspect.g:51:4: pointcutDeclaration
				{
				DebugLocation(51, 4);
				...
				{
					DebugLocation(52, 6);
					// UniAspect.g:52:6: ^( ELEMENT pointcutDeclaration )
					{
					object root_1 = (object)adaptor.Nil();
					DebugLocation(52, 8);
					root_1 = (object)adaptor.BecomeRoot((object)adaptor.Create(ELEMENT, "ELEMENT"), root_1);
			...
			case 3:
				DebugEnterAlt(3);
				// UniAspect.g:53:4: adviceDeclaration
				{
				DebugLocation(53, 4);
				...
				{
					DebugLocation(54, 6);
					// UniAspect.g:54:6: ^( ELEMENT adviceDeclaration )
					{
					object root_1 = (object)adaptor.Nil();
					DebugLocation(54, 8);
					root_1 = (object)adaptor.BecomeRoot((object)adaptor.Create(ELEMENT, "ELEMENT"), root_1);
	...
	// UniAspect.g:57:1: languageDependBlock : languageDeclaration '{' contents '}end' -> ^( LANGUAGE_DEPEND_BLOCK languageDeclaration contents ) ;
	[GrammarRule("languageDependBlock")]
	private UniAspectParser.languageDependBlock_return languageDependBlock()
	{
		Enter_languageDependBlock();
		EnterRule("languageDependBlock", 5);
		TraceIn("languageDependBlock", 5);
		UniAspectParser.languageDependBlock_return retval = new UniAspectParser.languageDependBlock_return();
		retval.Start = (IToken)input.LT(1);
		...
		UniAspectParser.languageDeclaration_return languageDeclaration11 = default(UniAspectParser.languageDeclaration_return);
		UniAspectParser.contents_return contents13 = default(UniAspectParser.contents_return);
		...
		try
		{
			// UniAspect.g:58:2: ( languageDeclaration '{' contents '}end' -> ^( LANGUAGE_DEPEND_BLOCK languageDeclaration contents ) )
			DebugEnterAlt(1);
			// UniAspect.g:58:4: languageDeclaration '{' contents '}end'
			{
			DebugLocation(58, 4);
			...
			{
				DebugLocation(59, 6);
				// UniAspect.g:59:6: ^( LANGUAGE_DEPEND_BLOCK languageDeclaration contents )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(59, 8);
	...
	// UniAspect.g:62:1: languageDeclaration : '@' languageType -> ^( LANGUAGE_DECLARATION languageType ) ;
	[GrammarRule("languageDeclaration")]
	private UniAspectParser.languageDeclaration_return languageDeclaration()
	{
		Enter_languageDeclaration();
		EnterRule("languageDeclaration", 6);
		TraceIn("languageDeclaration", 6);
		UniAspectParser.languageDeclaration_return retval = new UniAspectParser.languageDeclaration_return();
		retval.Start = (IToken)input.LT(1);

		object root_0 = null;

		IToken char_literal15=null;
		UniAspectParser.languageType_return languageType16 = default(UniAspectParser.languageType_return);
		...
		try
		{
			// UniAspect.g:63:2: ( '@' languageType -> ^( LANGUAGE_DECLARATION languageType ) )
			DebugEnterAlt(1);
			// UniAspect.g:63:4: '@' languageType
			{
			DebugLocation(63, 4);
			...
			{
				DebugLocation(64, 6);
				// UniAspect.g:64:6: ^( LANGUAGE_DECLARATION languageType )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(64, 8);
	...
	// UniAspect.g:67:1: languageType : ( 'Java' | 'JavaScript' | 'CSharp' | 'Ruby' | 'Python' | 'C' );
	[GrammarRule("languageType")]
	private UniAspectParser.languageType_return languageType()
	{
		Enter_languageType();
		EnterRule("languageType", 7);
		TraceIn("languageType", 7);
		UniAspectParser.languageType_return retval = new UniAspectParser.languageType_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:68:2: ( 'Java' | 'JavaScript' | 'CSharp' | 'Ruby' | 'Python' | 'C' )
			DebugEnterAlt(1);
			// UniAspect.g:
			{
			root_0 = (object)adaptor.Nil();
	...
	// UniAspect.g:71:1: intertypeDeclaration : targetClass ':' languageDependBlock -> ^( INTERTYPE_DECLARATION targetClass languageDependBlock ) ;
	[GrammarRule("intertypeDeclaration")]
	private UniAspectParser.intertypeDeclaration_return intertypeDeclaration()
	{
		Enter_intertypeDeclaration();
		EnterRule("intertypeDeclaration", 8);
		TraceIn("intertypeDeclaration", 8);
		UniAspectParser.intertypeDeclaration_return retval = new UniAspectParser.intertypeDeclaration_return();
		retval.Start = (IToken)input.LT(1);

		object root_0 = null;

		IToken char_literal19=null;
		UniAspectParser.targetClass_return targetClass18 = default(UniAspectParser.targetClass_return);
		UniAspectParser.languageDependBlock_return languageDependBlock20 = default(UniAspectParser.languageDependBlock_return);
		...
		try
		{
			// UniAspect.g:72:2: ( targetClass ':' languageDependBlock -> ^( INTERTYPE_DECLARATION targetClass languageDependBlock ) )
			DebugEnterAlt(1);
			// UniAspect.g:72:4: targetClass ':' languageDependBlock
			{
			DebugLocation(72, 4);
			...
			{
				DebugLocation(73, 6);
				// UniAspect.g:73:6: ^( INTERTYPE_DECLARATION targetClass languageDependBlock )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(73, 8);
	...
	// UniAspect.g:76:1: targetClass : IDENTIFIER -> ^( TARGET_CLASS IDENTIFIER ) ;
	[GrammarRule("targetClass")]
	private UniAspectParser.targetClass_return targetClass()
	{
		Enter_targetClass();
		EnterRule("targetClass", 9);
		TraceIn("targetClass", 9);
		UniAspectParser.targetClass_return retval = new UniAspectParser.targetClass_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:77:2: ( IDENTIFIER -> ^( TARGET_CLASS IDENTIFIER ) )
			DebugEnterAlt(1);
			// UniAspect.g:77:4: IDENTIFIER
			{
			DebugLocation(77, 4);
			...
			{
				DebugLocation(78, 6);
				// UniAspect.g:78:6: ^( TARGET_CLASS IDENTIFIER )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(78, 8);
	...
	// UniAspect.g:81:1: pointcutDeclaration : 'pointcut' pointcutName parameters ':' pointcutDeclarator ';' -> ^( POINTCUT_DECLARATION pointcutName parameters pointcutDeclarator ) ;
	[GrammarRule("pointcutDeclaration")]
	private UniAspectParser.pointcutDeclaration_return pointcutDeclaration()
	{
		Enter_pointcutDeclaration();
		EnterRule("pointcutDeclaration", 10);
		TraceIn("pointcutDeclaration", 10);
		UniAspectParser.pointcutDeclaration_return retval = new UniAspectParser.pointcutDeclaration_return();
		retval.Start = (IToken)input.LT(1);
		...
		UniAspectParser.pointcutName_return pointcutName23 = default(UniAspectParser.pointcutName_return);
		UniAspectParser.parameters_return parameters24 = default(UniAspectParser.parameters_return);
		UniAspectParser.pointcutDeclarator_return pointcutDeclarator26 = default(UniAspectParser.pointcutDeclarator_return);
		...
		try
		{
			// UniAspect.g:82:2: ( 'pointcut' pointcutName parameters ':' pointcutDeclarator ';' -> ^( POINTCUT_DECLARATION pointcutName parameters pointcutDeclarator ) )
			DebugEnterAlt(1);
			// UniAspect.g:82:4: 'pointcut' pointcutName parameters ':' pointcutDeclarator ';'
			{
			DebugLocation(82, 4);
			...
			{
				DebugLocation(83, 6);
				// UniAspect.g:83:6: ^( POINTCUT_DECLARATION pointcutName parameters pointcutDeclarator )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(83, 8);
	...
	// UniAspect.g:86:1: pointcutName : IDENTIFIER -> ^( POINTCUT_NAME IDENTIFIER ) ;
	[GrammarRule("pointcutName")]
	private UniAspectParser.pointcutName_return pointcutName()
	{
		Enter_pointcutName();
		EnterRule("pointcutName", 11);
		TraceIn("pointcutName", 11);
		UniAspectParser.pointcutName_return retval = new UniAspectParser.pointcutName_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:87:2: ( IDENTIFIER -> ^( POINTCUT_NAME IDENTIFIER ) )
			DebugEnterAlt(1);
			// UniAspect.g:87:4: IDENTIFIER
			{
			DebugLocation(87, 4);
			...
			{
				DebugLocation(88, 6);
				// UniAspect.g:88:6: ^( POINTCUT_NAME IDENTIFIER )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(88, 8);
	...
	// UniAspect.g:91:1: parameters : '(' ( parameter )* ')' -> ^( PARAMETERS ( parameter )* ) ;
	[GrammarRule("parameters")]
	private UniAspectParser.parameters_return parameters()
	{
		Enter_parameters();
		EnterRule("parameters", 12);
		TraceIn("parameters", 12);
		UniAspectParser.parameters_return retval = new UniAspectParser.parameters_return();
		retval.Start = (IToken)input.LT(1);
		...
		UniAspectParser.parameter_return parameter30 = default(UniAspectParser.parameter_return);
		...
		try
		{
			// UniAspect.g:92:2: ( '(' ( parameter )* ')' -> ^( PARAMETERS ( parameter )* ) )
			DebugEnterAlt(1);
			// UniAspect.g:92:4: '(' ( parameter )* ')'
			{
			DebugLocation(92, 4);
			...
			{
				DebugLocation(93, 6);
				// UniAspect.g:93:6: ^( PARAMETERS ( parameter )* )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(93, 8);
	...
	// UniAspect.g:96:1: parameter : parameterType IDENTIFIER -> ^( PARAMETER parameterType IDENTIFIER ) ;
	[GrammarRule("parameter")]
	private UniAspectParser.parameter_return parameter()
	{
		Enter_parameter();
		EnterRule("parameter", 13);
		TraceIn("parameter", 13);
		UniAspectParser.parameter_return retval = new UniAspectParser.parameter_return();
		retval.Start = (IToken)input.LT(1);

		object root_0 = null;

		IToken IDENTIFIER33=null;
		UniAspectParser.parameterType_return parameterType32 = default(UniAspectParser.parameterType_return);
		...
		try
		{
			// UniAspect.g:97:2: ( parameterType IDENTIFIER -> ^( PARAMETER parameterType IDENTIFIER ) )
			DebugEnterAlt(1);
			// UniAspect.g:97:4: parameterType IDENTIFIER
			{
			DebugLocation(97, 4);
			...
			{
				DebugLocation(98, 6);
				// UniAspect.g:98:6: ^( PARAMETER parameterType IDENTIFIER )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(98, 8);
	...
	// UniAspect.g:101:1: parameterType : IDENTIFIER -> ^( PARAMETER_TYPE IDENTIFIER ) ;
	[GrammarRule("parameterType")]
	private UniAspectParser.parameterType_return parameterType()
	{
		Enter_parameterType();
		EnterRule("parameterType", 14);
		TraceIn("parameterType", 14);
		UniAspectParser.parameterType_return retval = new UniAspectParser.parameterType_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:102:2: ( IDENTIFIER -> ^( PARAMETER_TYPE IDENTIFIER ) )
			DebugEnterAlt(1);
			// UniAspect.g:102:4: IDENTIFIER
			{
			DebugLocation(102, 4);
			...
			{
				DebugLocation(103, 6);
				// UniAspect.g:103:6: ^( PARAMETER_TYPE IDENTIFIER )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(103, 8);
	...
	// UniAspect.g:107:1: pointcutDeclarator : pointcutType '(' type identifierWithClassName arguments ')' -> ^( POINTCUT_DECLARATOR pointcutType type identifierWithClassName arguments ) ;
	[GrammarRule("pointcutDeclarator")]
	private UniAspectParser.pointcutDeclarator_return pointcutDeclarator()
	{
		Enter_pointcutDeclarator();
		EnterRule("pointcutDeclarator", 15);
		TraceIn("pointcutDeclarator", 15);
		UniAspectParser.pointcutDeclarator_return retval = new UniAspectParser.pointcutDeclarator_return();
		retval.Start = (IToken)input.LT(1);
		...
		UniAspectParser.pointcutType_return pointcutType35 = default(UniAspectParser.pointcutType_return);
		UniAspectParser.type_return type37 = default(UniAspectParser.type_return);
		UniAspectParser.identifierWithClassName_return identifierWithClassName38 = default(UniAspectParser.identifierWithClassName_return);
		UniAspectParser.arguments_return arguments39 = default(UniAspectParser.arguments_return);
		...
		try
		{
			// UniAspect.g:108:2: ( pointcutType '(' type identifierWithClassName arguments ')' -> ^( POINTCUT_DECLARATOR pointcutType type identifierWithClassName arguments ) )
			DebugEnterAlt(1);
			// UniAspect.g:108:4: pointcutType '(' type identifierWithClassName arguments ')'
			{
			DebugLocation(108, 4);
			PushFollow(Follow._pointcutType_in_pointcutDeclarator510);
			...
			PushFollow(Follow._identifierWithClassName_in_pointcutDeclarator516);
			...
			PushFollow(Follow._arguments_in_pointcutDeclarator518);
			...
			{
			// AST REWRITE
			// elements: pointcutType, identifierWithClassName, type, arguments
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
			...
			root_0 = (object)adaptor.Nil();
			// 109:3: -> ^( POINTCUT_DECLARATOR pointcutType type identifierWithClassName arguments )
			{
				DebugLocation(109, 6);
				// UniAspect.g:109:6: ^( POINTCUT_DECLARATOR pointcutType type identifierWithClassName arguments )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(109, 8);
	...
	// UniAspect.g:112:1: pointcutType : IDENTIFIER -> ^( POINTCUT_TYPE IDENTIFIER ) ;
	[GrammarRule("pointcutType")]
	private UniAspectParser.pointcutType_return pointcutType()
	{
		Enter_pointcutType();
		EnterRule("pointcutType", 16);
		TraceIn("pointcutType", 16);
		UniAspectParser.pointcutType_return retval = new UniAspectParser.pointcutType_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:113:2: ( IDENTIFIER -> ^( POINTCUT_TYPE IDENTIFIER ) )
			DebugEnterAlt(1);
			// UniAspect.g:113:4: IDENTIFIER
			{
			DebugLocation(113, 4);
			IDENTIFIER41=(IToken)Match(input,IDENTIFIER,Follow._IDENTIFIER_in_pointcutType547);  
			...
			root_0 = (object)adaptor.Nil();
			// 114:3: -> ^( POINTCUT_TYPE IDENTIFIER )
			{
				DebugLocation(114, 6);
				// UniAspect.g:114:6: ^( POINTCUT_TYPE IDENTIFIER )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(114, 8);
	...
	// $ANTLR start "type"
	// UniAspect.g:117:1: type : IDENTIFIER -> ^( TYPE IDENTIFIER ) ;
	[GrammarRule("type")]
	private UniAspectParser.type_return type()
	{
		Enter_type();
		EnterRule("type", 17);
		TraceIn("type", 17);
		UniAspectParser.type_return retval = new UniAspectParser.type_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:118:2: ( IDENTIFIER -> ^( TYPE IDENTIFIER ) )
			DebugEnterAlt(1);
			// UniAspect.g:118:4: IDENTIFIER
			{
			DebugLocation(118, 4);
			IDENTIFIER42=(IToken)Match(input,IDENTIFIER,Follow._IDENTIFIER_in_type568);  
			...
			root_0 = (object)adaptor.Nil();
			// 119:3: -> ^( TYPE IDENTIFIER )
			{
				DebugLocation(119, 6);
				// UniAspect.g:119:6: ^( TYPE IDENTIFIER )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(119, 8);
	...
	// UniAspect.g:122:1: identifierWithClassName : IDENTIFIER ( '.' IDENTIFIER )+ -> ^( IDENTIFIER_WITH_CLASS_NAME ( IDENTIFIER )+ ) ;
	[GrammarRule("identifierWithClassName")]
	private UniAspectParser.identifierWithClassName_return identifierWithClassName()
	{
		Enter_identifierWithClassName();
		EnterRule("identifierWithClassName", 18);
		TraceIn("identifierWithClassName", 18);
		UniAspectParser.identifierWithClassName_return retval = new UniAspectParser.identifierWithClassName_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:123:2: ( IDENTIFIER ( '.' IDENTIFIER )+ -> ^( IDENTIFIER_WITH_CLASS_NAME ( IDENTIFIER )+ ) )
			DebugEnterAlt(1);
			// UniAspect.g:123:4: IDENTIFIER ( '.' IDENTIFIER )+
			{
			DebugLocation(123, 4);
			IDENTIFIER43=(IToken)Match(input,IDENTIFIER,Follow._IDENTIFIER_in_identifierWithClassName589);  
			stream_IDENTIFIER.Add(IDENTIFIER43);

			DebugLocation(123, 15);
			// UniAspect.g:123:15: ( '.' IDENTIFIER )+
			int cnt4=0;
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// UniAspect.g:123:16: '.' IDENTIFIER
					{
					DebugLocation(123, 16);
					char_literal44=(IToken)Match(input,49,Follow._49_in_identifierWithClassName592);  
					stream_49.Add(char_literal44);

					DebugLocation(123, 20);
					IDENTIFIER45=(IToken)Match(input,IDENTIFIER,Follow._IDENTIFIER_in_identifierWithClassName594);  
			...
			root_0 = (object)adaptor.Nil();
			// 124:3: -> ^( IDENTIFIER_WITH_CLASS_NAME ( IDENTIFIER )+ )
			{
				DebugLocation(124, 6);
				// UniAspect.g:124:6: ^( IDENTIFIER_WITH_CLASS_NAME ( IDENTIFIER )+ )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(124, 8);
	...
	// UniAspect.g:127:1: arguments : '(' ')' ;
	[GrammarRule("arguments")]
	private UniAspectParser.arguments_return arguments()
	{
		Enter_arguments();
		EnterRule("arguments", 19);
		TraceIn("arguments", 19);
		UniAspectParser.arguments_return retval = new UniAspectParser.arguments_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			...
			DebugLocation(128, 4);
			char_literal46=(IToken)Match(input,47,Follow._47_in_arguments618); 
			char_literal46_tree = (object)adaptor.Create(char_literal46);
			adaptor.AddChild(root_0, char_literal46_tree);

			DebugLocation(128, 8);
			char_literal47=(IToken)Match(input,48,Follow._48_in_arguments620); 
	...
	// UniAspect.g:131:1: adviceDeclaration : adviceType ':' adviceTarget parameters adviceBody -> ^( ADVICE_DECLARATION adviceType adviceTarget parameters adviceBody ) ;
	[GrammarRule("adviceDeclaration")]
	private UniAspectParser.adviceDeclaration_return adviceDeclaration()
	{
		Enter_adviceDeclaration();
		EnterRule("adviceDeclaration", 20);
		TraceIn("adviceDeclaration", 20);
		UniAspectParser.adviceDeclaration_return retval = new UniAspectParser.adviceDeclaration_return();
		retval.Start = (IToken)input.LT(1);

		object root_0 = null;

		IToken char_literal49=null;
		UniAspectParser.adviceType_return adviceType48 = default(UniAspectParser.adviceType_return);
		UniAspectParser.adviceTarget_return adviceTarget50 = default(UniAspectParser.adviceTarget_return);
		UniAspectParser.parameters_return parameters51 = default(UniAspectParser.parameters_return);
		UniAspectParser.adviceBody_return adviceBody52 = default(UniAspectParser.adviceBody_return);
		...
		try
		{
			// UniAspect.g:132:2: ( adviceType ':' adviceTarget parameters adviceBody -> ^( ADVICE_DECLARATION adviceType adviceTarget parameters adviceBody ) )
			DebugEnterAlt(1);
			// UniAspect.g:132:4: adviceType ':' adviceTarget parameters adviceBody
			{
			DebugLocation(132, 4);
			PushFollow(Follow._adviceType_in_adviceDeclaration631);
			adviceType48=adviceType();
			PopFollow();

			stream_adviceType.Add(adviceType48.Tree);
			DebugLocation(132, 15);
			char_literal49=(IToken)Match(input,44,Follow._44_in_adviceDeclaration633);  
			stream_44.Add(char_literal49);

			DebugLocation(132, 19);
			PushFollow(Follow._adviceTarget_in_adviceDeclaration635);
			adviceTarget50=adviceTarget();
			PopFollow();

			stream_adviceTarget.Add(adviceTarget50.Tree);
			DebugLocation(132, 32);
			PushFollow(Follow._parameters_in_adviceDeclaration637);
			parameters51=parameters();
			PopFollow();

			stream_parameters.Add(parameters51.Tree);
			DebugLocation(132, 43);
			PushFollow(Follow._adviceBody_in_adviceDeclaration639);
			...
			{
			// AST REWRITE
			// elements: adviceTarget, parameters, adviceBody, adviceType
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
			...
			root_0 = (object)adaptor.Nil();
			// 133:3: -> ^( ADVICE_DECLARATION adviceType adviceTarget parameters adviceBody )
			{
				DebugLocation(133, 6);
				// UniAspect.g:133:6: ^( ADVICE_DECLARATION adviceType adviceTarget parameters adviceBody )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(133, 8);
	...
	// UniAspect.g:136:1: adviceType : ADVICE_TYPE_ELEMENT -> ^( ADVICE_TYPE ADVICE_TYPE_ELEMENT ) ;
	[GrammarRule("adviceType")]
	private UniAspectParser.adviceType_return adviceType()
	{
		Enter_adviceType();
		EnterRule("adviceType", 21);
		TraceIn("adviceType", 21);
		UniAspectParser.adviceType_return retval = new UniAspectParser.adviceType_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:137:2: ( ADVICE_TYPE_ELEMENT -> ^( ADVICE_TYPE ADVICE_TYPE_ELEMENT ) )
			DebugEnterAlt(1);
			// UniAspect.g:137:4: ADVICE_TYPE_ELEMENT
			{
			DebugLocation(137, 4);
			ADVICE_TYPE_ELEMENT53=(IToken)Match(input,ADVICE_TYPE_ELEMENT,Follow._ADVICE_TYPE_ELEMENT_in_adviceType667);  
			...
			root_0 = (object)adaptor.Nil();
			// 138:3: -> ^( ADVICE_TYPE ADVICE_TYPE_ELEMENT )
			{
				DebugLocation(138, 6);
				// UniAspect.g:138:6: ^( ADVICE_TYPE ADVICE_TYPE_ELEMENT )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(138, 8);
	...
	// UniAspect.g:145:1: adviceTarget : IDENTIFIER -> ^( ADVICE_TARGET IDENTIFIER ) ;
	[GrammarRule("adviceTarget")]
	private UniAspectParser.adviceTarget_return adviceTarget()
	{
		Enter_adviceTarget();
		EnterRule("adviceTarget", 22);
		TraceIn("adviceTarget", 22);
		UniAspectParser.adviceTarget_return retval = new UniAspectParser.adviceTarget_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:146:2: ( IDENTIFIER -> ^( ADVICE_TARGET IDENTIFIER ) )
			DebugEnterAlt(1);
			// UniAspect.g:146:4: IDENTIFIER
			{
			DebugLocation(146, 4);
			IDENTIFIER54=(IToken)Match(input,IDENTIFIER,Follow._IDENTIFIER_in_adviceTarget703);  
			...
			root_0 = (object)adaptor.Nil();
			// 147:3: -> ^( ADVICE_TARGET IDENTIFIER )
			{
				DebugLocation(147, 6);
				// UniAspect.g:147:6: ^( ADVICE_TARGET IDENTIFIER )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(147, 8);
	...
	// UniAspect.g:150:1: adviceBody : '{' ( languageDependBlock )+ '}' -> ^( ADVICE_BODY ( languageDependBlock )+ ) ;
	[GrammarRule("adviceBody")]
	private UniAspectParser.adviceBody_return adviceBody()
	{
		Enter_adviceBody();
		EnterRule("adviceBody", 23);
		TraceIn("adviceBody", 23);
		UniAspectParser.adviceBody_return retval = new UniAspectParser.adviceBody_return();
		retval.Start = (IToken)input.LT(1);
		...
		UniAspectParser.languageDependBlock_return languageDependBlock56 = default(UniAspectParser.languageDependBlock_return);
		...
		try
		{
			// UniAspect.g:151:2: ( '{' ( languageDependBlock )+ '}' -> ^( ADVICE_BODY ( languageDependBlock )+ ) )
			DebugEnterAlt(1);
			// UniAspect.g:151:4: '{' ( languageDependBlock )+ '}'
			{
			DebugLocation(151, 4);
			char_literal55=(IToken)Match(input,34,Follow._34_in_adviceBody724);  
			stream_34.Add(char_literal55);

			DebugLocation(151, 8);
			// UniAspect.g:151:8: ( languageDependBlock )+
			int cnt5=0;
			...
			while (true)
			{
				...
				case 1:
					...
					{
					DebugLocation(151, 8);
					PushFollow(Follow._languageDependBlock_in_adviceBody726);
			...
			char_literal57=(IToken)Match(input,35,Follow._35_in_adviceBody729);  
			...
			root_0 = (object)adaptor.Nil();
			// 152:3: -> ^( ADVICE_BODY ( languageDependBlock )+ )
			{
				DebugLocation(152, 6);
				// UniAspect.g:152:6: ^( ADVICE_BODY ( languageDependBlock )+ )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(152, 8);
	...
	// UniAspect.g:155:1: contents : content -> ^( CONTENTS content ) ;
	[GrammarRule("contents")]
	private UniAspectParser.contents_return contents()
	{
		Enter_contents();
		EnterRule("contents", 24);
		TraceIn("contents", 24);
		UniAspectParser.contents_return retval = new UniAspectParser.contents_return();
		retval.Start = (IToken)input.LT(1);

		object root_0 = null;

		UniAspectParser.content_return content58 = default(UniAspectParser.content_return);
		...
		try
		{
			// UniAspect.g:156:2: ( content -> ^( CONTENTS content ) )
			DebugEnterAlt(1);
			// UniAspect.g:156:4: content
			{
			DebugLocation(156, 4);
			PushFollow(Follow._content_in_contents751);
			content58=content();
			PopFollow();
			...
			root_0 = (object)adaptor.Nil();
			// 157:3: -> ^( CONTENTS content )
			{
				DebugLocation(157, 6);
				// UniAspect.g:157:6: ^( CONTENTS content )
				{
				object root_1 = (object)adaptor.Nil();
				DebugLocation(157, 8);
	...
	// $ANTLR start "content"
	// UniAspect.g:160:1: content : ( IDENTIFIER | INTLITERAL | STRING | WS | ~ ( '}end' | IDENTIFIER | INTLITERAL | WS ) )* ;
	[GrammarRule("content")]
	private UniAspectParser.content_return content()
	{
		Enter_content();
		EnterRule("content", 25);
		TraceIn("content", 25);
		UniAspectParser.content_return retval = new UniAspectParser.content_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:161:2: ( ( IDENTIFIER | INTLITERAL | STRING | WS | ~ ( '}end' | IDENTIFIER | INTLITERAL | WS ) )* )
			DebugEnterAlt(1);
			// UniAspect.g:161:4: ( IDENTIFIER | INTLITERAL | STRING | WS | ~ ( '}end' | IDENTIFIER | INTLITERAL | WS ) )*
			{
			root_0 = (object)adaptor.Nil();
	...
	// UniAspect.g:165:1: variableInitializer : '=' INTLITERAL ;
	[GrammarRule("variableInitializer")]
	private UniAspectParser.variableInitializer_return variableInitializer()
	{
		Enter_variableInitializer();
		EnterRule("variableInitializer", 26);
		TraceIn("variableInitializer", 26);
		UniAspectParser.variableInitializer_return retval = new UniAspectParser.variableInitializer_return();
		retval.Start = (IToken)input.LT(1);
		...
		try
		{
			// UniAspect.g:166:2: ( '=' INTLITERAL )
			DebugEnterAlt(1);
			// UniAspect.g:166:4: '=' INTLITERAL
			{
			root_0 = (object)adaptor.Nil();

			DebugLocation(166, 4);
			char_literal60=(IToken)Match(input,50,Follow._50_in_variableInitializer819); 
			char_literal60_tree = (object)adaptor.Create(char_literal60);
			adaptor.AddChild(root_0, char_literal60_tree);

			DebugLocation(166, 8);
			INTLITERAL61=(IToken)Match(input,INTLITERAL,Follow._INTLITERAL_in_variableInitializer821); 
	...
	private static class Follow
	{
		...
		public static readonly BitSet _34_in_aspectBody150 = new BitSet(new ulong[]{0x20080C000000UL});
		...
		public static readonly BitSet _element_in_elements175 = new BitSet(new ulong[]{0x20000C000002UL});
		...
		public static readonly BitSet _44_in_pointcutDeclaration386 = new BitSet(new ulong[]{0x4000000UL});
		...
		public static readonly BitSet _IDENTIFIER_in_pointcutType547 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENTIFIER_in_type568 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENTIFIER_in_identifierWithClassName589 = new BitSet(new ulong[]{0x2000000000000UL});
		public static readonly BitSet _49_in_identifierWithClassName592 = new BitSet(new ulong[]{0x4000000UL});
		public static readonly BitSet _IDENTIFIER_in_identifierWithClassName594 = new BitSet(new ulong[]{0x2000000000002UL});
		public static readonly BitSet _47_in_arguments618 = new BitSet(new ulong[]{0x1000000000000UL});
		public static readonly BitSet _48_in_arguments620 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _adviceType_in_adviceDeclaration631 = new BitSet(new ulong[]{0x100000000000UL});
		public static readonly BitSet _44_in_adviceDeclaration633 = new BitSet(new ulong[]{0x4000000UL});
		public static readonly BitSet _adviceTarget_in_adviceDeclaration635 = new BitSet(new ulong[]{0x800000000000UL});
		public static readonly BitSet _parameters_in_adviceDeclaration637 = new BitSet(new ulong[]{0x400000000UL});
		public static readonly BitSet _adviceBody_in_adviceDeclaration639 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _ADVICE_TYPE_ELEMENT_in_adviceType667 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IDENTIFIER_in_adviceTarget703 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _34_in_adviceBody724 = new BitSet(new ulong[]{0x2000000000UL});
		public static readonly BitSet _languageDependBlock_in_adviceBody726 = new BitSet(new ulong[]{0x2800000000UL});
		public static readonly BitSet _35_in_adviceBody729 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _content_in_contents751 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _set_in_content772 = new BitSet(new ulong[]{0x7FFEFFFFFFFF2UL});
		public static readonly BitSet _50_in_variableInitializer819 = new BitSet(new ulong[]{0x10000000UL});
		public static readonly BitSet _INTLITERAL_in_variableInitializer821 = new BitSet(new ulong[]{0x2UL});
